...
main(int argc, char** argv)
{
   ...
   std::ofstream fout("stats/d20evt100statsedmondsde1.txt");
   ...
   while((evt = lcReader->readNextEvent()) != 0)
   {
      ...
      std::cout << "E_0 | E_0max | E_MC0 = " << hcalenergycomponent<E,V>(gsamedmonds,0)
                << " | "                     << hcalenergyparent<E,V>(gsamedmonds, -211)
                << " | "                     << gsamedmonds[0].energy                                           << std::endl;
      std::cout << "E_1 | E_1max | E_MC0 = " << hcalenergycomponent<E,V>(gsamedmonds,1)
                << " | "                     << hcalenergyparent<E,V>(gsamedmonds, 311)
                << " | "                     << gsamedmonds[1].energy                                           << std::endl;
      ...
      std::cout << "Purity | Puritymin   = " << purity<E,V>(gsamedmonds)
                << " | "                     << minimumpurity<E,V>(gsamedmonds)                                 << std::endl;
      std::cout << "Parents comp0        = " << numberparentscomponent<E,V>(gsamedmonds,-211,0) << " x (-211) "
                                             << numberparentscomponent<E,V>(gsamedmonds,311, 0) << " x 311 "    << std::endl;
      std::cout << "Parents comp1        = " << numberparentscomponent<E,V>(gsamedmonds,-211,1) << " x (-211) "
                                             << numberparentscomponent<E,V>(gsamedmonds,311,1)  << " x 311 "    << std::endl;
      std::cout << std::endl;
