...
main()
{
   ...
   std::cout << "E_0 | E_MC0 = " << examplehcalenergycomponent<E,V>(gmstkruskal,0)
             << " | "            << gmstkruskal[0].energy << std::endl;
   std::cout << "E_1 | E_MC1 = " << examplehcalenergycomponent<E,V>(gmstkruskal,1)
   ...
   std::cout << "Parents c0  = " << examplenumberparentscomponent<E,V>(gmstkruskal,0,0) << " x (0) "
                                 << examplenumberparentscomponent<E,V>(gmstkruskal,1,0) << " x (1) " << std::endl;
   std::cout << "Parents c1  = " << examplenumberparentscomponent<E,V>(gmstkruskal,0,1) << " x (0) "
                                 << examplenumberparentscomponent<E,V>(gmstkruskal,1,1) << " x (1) " << std::endl;
   ...
   std::cout << "E_0 | E_MC0 = " << examplehcalenergycomponent<E,V>(gmstprim,0)
             << " | "            << gmstprim[0].energy                                            << std::endl;
   std::cout << "E_1 | E_MC1 = " << examplehcalenergycomponent<E,V>(gmstprim,1)
   ...
   std::cout << "Parents c0  = " << examplenumberparentscomponent<E,V>(gmstprim,0,0) << " x (0) "
                                 << examplenumberparentscomponent<E,V>(gmstprim,1,0) << " x (1) " << std::endl;
   std::cout << "Parents c1  = " << examplenumberparentscomponent<E,V>(gmstprim,0,1) << " x (0) "
                                 << examplenumberparentscomponent<E,V>(gmstprim,1,1) << " x (1) " << std::endl;
