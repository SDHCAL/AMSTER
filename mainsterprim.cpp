...
main(int argc, char** argv)
{
   ...
   std::ofstream fout("d15k010pim30k010evt1000statsprimoriented.txt");
   ...
   //while((evt = lcReader->readNextEvent()) != 0)
   {
      ...
      std::cout << "E_0 | E_0max | E_MC0 = " << hcalenergycomponent<E,V>(gmstprim,0) << " | " << hcalenergyparent<E,V>(gmstprim, -211) << " | " << gmstprim[0].energy << std::endl;
      std::cout << "E_1 | E_1max | E_MC0 = " << hcalenergycomponent<E,V>(gmstprim,1) << " | " << hcalenergyparent<E,V>(gmstprim, 311) << " | " << gmstprim[1].energy << std::endl;
      ...
      std::cout << "Purity | Puritymin   = " << purity<E,V>(gmstprim) << " | " << minimumpurity<E,V>(gmstprim) << std::endl;
      std::cout << "Parents c0           = " << numberparentscomponent<E,V>(gmstprim,-211,0) << " x (-211) "
                                             << numberparentscomponent<E,V>(gmstprim,311, 0) << " x 311 "
                                             << std::endl;
      std::cout << "Parents c1           = " << numberparentscomponent<E,V>(gmstprim,-211,1) << " x (-211) "
                                             << numberparentscomponent<E,V>(gmstprim,311,1)  << " x 311 "
                                             << std::endl;
      std::cout << std::endl;
